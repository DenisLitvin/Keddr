...
class CommentCell: BaseCell {
    ...
    override func setupViews() {
        ...
        replyButton.anchor(top: nil, left: bubbleView.leftAnchor, bottom: bubbleView.bottomAnchor, right: nil, topConstant: 0, leftConstant: 15, bottomConstant: 4, rightConstant: 0, widthConstant: 110, heightConstant: 30)
